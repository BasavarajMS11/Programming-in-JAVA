...
public class ShoppingDemo1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShoppingDemo1 frame = new ShoppingDemo1();
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=0;i<5;i++)
				{
					if(customers[i].custName==id)
					{
						...
						String udata= "\n"+ customers[i].custName + ":" + customers[i].shopName +":" +customers[i].billAmount;
